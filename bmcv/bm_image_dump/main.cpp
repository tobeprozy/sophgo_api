...
int main(int argc, char* argv[]) {
  ...
  bm_image img_crop;
  bm_image_create(bm_handle, padding_attr.dst_crop_h, padding_attr.dst_crop_w,FORMAT_BGR_PLANAR, bmimg.data_type, &img_crop);
  auto ret = bmcv_image_vpp_convert_padding(bm_handle, 1, bmimg, &img_crop,

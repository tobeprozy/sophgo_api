 ...
 * spectral_embeddings_global_addr is postprocessed eignvector
 * num_spks_global_addr            is dynamic num_spks
 * eignvalue_global_addr           is origin eignvalue
 * eignvector_global_addr          is origin eignvector
 * shape     is input matrix shape
 * shape_dim is input matrix dims
 * num_iter_QR is iterations of QR
 * buffer_coeff means buffer_size =  buffer_coeff * n* n, where n is matrix col/row
 * num_spks is num of user-given cols of postprocessed eignvector
 ...
 * shape is input matrix shape
*/
DECL_EXPORT bm_status_t bmcv_qr(
    bm_handle_t handle,
    bm_device_mem_t spectral_embeddings_global_addr,
    bm_device_mem_t num_spks_global_addr,
    bm_device_mem_t eignvalue_global_addr,
    bm_device_mem_t eignvector_global_addr,

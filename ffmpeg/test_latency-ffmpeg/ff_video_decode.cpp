                             ...
                             int api_version)
{
    ...
    av_dict_set(&dict, "probesize", "2048", 0); // for reducing latency
    av_dict_set(&dict, "analyzeduration", "300000", 0); // for reducing latency
    av_dict_set(&dict, "buffer_size", "1024", 0); // for reducing latency
    av_dict_set(&dict, "recv_buffer_size", "1024", 0); // for reducing latency
    av_dict_set(&dict, "fflags", "+nobuffer", 0); // nobuffer for reducing latency
